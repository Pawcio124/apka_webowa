 ...
 */
final class Version20191112162143 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, author_id, project_id, content, place, done, date_end_task FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, project_id INTEGER NOT NULL, content CLOB NOT NULL, place VARCHAR(255) DEFAULT NULL, done BOOLEAN NOT NULL, date_end_task DATETIME NOT NULL)');
        $this->addSql('INSERT INTO task (id, author_id, project_id, content, place, done, date_end_task) SELECT id, author_id, project_id, content, place, done, date_end_task FROM __temp__task');
        $this->addSql('DROP TABLE __temp__task');
        $this->addSql('CREATE INDEX IDX_527EDB25F675F31B ON task (author_id)');
        $this->addSql('CREATE INDEX IDX_527EDB25166D1F9C ON task (project_id)');
