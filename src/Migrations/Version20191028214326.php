 ...
 */
final class Version20191028214326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN confirmation_token VARCHAR(40) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_527EDB25F675F31B ON task (author_id)');
        $this->addSql('CREATE INDEX IDX_527EDB25166D1F9C ON task (project_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, email, roles, password_change_date FROM user');
        ...
        $this->addSql('INSERT INTO user (id, username, password, email, roles, password_change_date) SELECT id, username, password, email, roles, password_change_date FROM __temp__user');
