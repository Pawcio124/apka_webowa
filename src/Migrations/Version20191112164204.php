 ...
 */
final class Version20191112164204 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, project_id INTEGER NOT NULL, content CLOB NOT NULL, done BOOLEAN NOT NULL, place VARCHAR(255) NOT NULL COLLATE BINARY, date_end_task DATETIME NOT NULL)');
