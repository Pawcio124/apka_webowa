 ...
 */
final class Version20191031204000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, email, roles, password_change_date, confirmation_token, enabled FROM user');
        ...
        $this->addSql('INSERT INTO user (id, username, password, email, roles, password_change_date, confirmation_token, enabled) SELECT id, username, password, email, roles, password_change_date, confirmation_token, enabled FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, date DATETIME NOT NULL, content CLOB NOT NULL, slug VARCHAR(255) DEFAULT NULL, images_id INTEGER DEFAULT NULL)');
        ...
        , password_change_date INTEGER DEFAULT NULL, enabled BOOLEAN NOT NULL, confirmation_token VARCHAR(40) DEFAULT NULL, profilepictures_id INTEGER DEFAULT NULL)');
