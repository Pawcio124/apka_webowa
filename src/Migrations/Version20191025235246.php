 ...
 */
final class Version20191025235246 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, author_id, content, place FROM task');
        ...
        $this->addSql('INSERT INTO task (id, author_id, content, place) SELECT id, author_id, content, place FROM __temp__task');
